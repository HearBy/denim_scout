...
def make_garments
	...
	Garment.create!(model: "SK 14.5oz",
				   brand: "Rogue Territory",
				   color: "Indigo",
	...
	Garment.create!(model: "Stealth SK 15oz",
				   brand: "Rogue Territory",
				   color: "Black",
				   fabric_origin: "Nehon Menpu Mills",
				   made_in: "USA",
	...
	Garment.create!(model: "Tonal Stitch Weird Guy",
				   brand: "Naked & Famous",
				   color: "Indigo",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Red Core Weird Guy",
				   brand: "Naked & Famous",
				   color: "Indigo",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Broken Twill Slim Guy",
				   brand: "Naked & Famous",
				   color: "Indigo",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Black Power Stretch Super Skinny Guy",
				   brand: "Naked & Famous",
				   color: "Black",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Indigo Stretch Super Skinny Guy",
				   brand: "Naked & Famous",
				   color: "Indigo",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Vintage Nudes Weird Guy",
				   brand: "Naked & Famous",
				   color: "Indigo",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Vintagecast Broken Twill Weird Guy",
				   brand: "Naked & Famous",
				   color: "Light Indigo",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Midnight Selvedge Weird Guy",
				   brand: "Naked & Famous",
				   color: "Dark Indigo",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Grey Stretch Skinny Guy",
				   brand: "Naked & Famous",
				   color: "Gray",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Dirty Fade Weird Guy",
				   brand: "Naked & Famous",
				   color: "Indigo",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Rainbow Core Weird Guy",
				   brand: "Naked & Famous",
				   color: "Indigo",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Arctic Selvedge Weird Guy",
				   brand: "Naked & Famous",
				   color: "Gray",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Flannel Denim Weird Guy",
				   brand: "Naked & Famous",
				   color: "Indigo",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Midnight Power Stretch Skinny Guy",
				   brand: "Naked & Famous",
				   color: "Dark Indigo",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Heather Gray Stretch Skinny Guy",
				   brand: "Naked & Famous",
				   color: "Gray",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Stretch Selvedge Weird Guy",
				   brand: "Naked & Famous",
				   color: "Indigo",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Suvin Selvedge Weird Guy",
				   brand: "Naked & Famous",
				   color: "Indigo",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "Naked & Famous x Kamikaze Attack Skinny Guy",
	...
	Garment.create!(model: "Black Power Stretch Skinny Guy",
				   brand: "Naked & Famous",
				   color: "Black",
				   fabric_origin: "Japan",
				   made_in: "Canada",
	...
	Garment.create!(model: "High Slim",
				   brand: "Cheap Monday",
				   color: "Black",
				   fabric_origin: "China",
				   made_in: "China",
	...
	#46 Nudie Thin Finn
	Garment.create!(model: "Thin Finn Organic Dry",
				   brand: "Nudie",
				   color: "Indigo",
	...
	Garment.create!(model: "John Graham Mellor",
				   brand: "Tellason",
				   color: "Indigo",
	...
	Garment.create!(model: "Ladbroke Grove",
				   brand: "Tellason",
				   color: "Indigo",
				   fabric_origin: "Cone Mills",
				   made_in: "USA",
	...
	Garment.create!(model: "Slim 5-Pocket Jean",
				   brand: "Wings+Horns",
				   color: "Indigo",
				   fabric_origin: "Cone Mills",
				   made_in: "USA",
	...
	Garment.create!(model: "Tonal Stitch Stanton",
				   brand: "Rogue Territory",
				   color: "Indigo",
	...
	Garment.create!(model: "Martin Tinted",
				   brand: "Raleigh Denim",
				   color: "Indigo",
				   fabric_origin: "Cone Mills",
				   made_in: "USA",
	...
	Garment.create!(model: "Alexander Original Selvedge",
				   brand: "Raleigh Denim",
				   color: "Indigo",
				   fabric_origin: "Cone Mills",
				   made_in: "USA",
	...
	Garment.create!(model: "Jones Original Selvedge",
				   brand: "Raleigh Denim",
				   color: "Indigo",
				   fabric_origin: "Cone Mills",
				   made_in: "USA",
	...
	Garment.create!(model: "Hand Dye Raw",
